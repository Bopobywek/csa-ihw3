...
Степенной ряд для данной функции сходится на полуинтервале [-1, 1), поэтому на входные данные наложено ограничение.  
...
### Вывод
Модифицированная программа показала отличные результаты: она стала лидером не только по размеру ассемблерного и исполняемого файлов, но и по времени исполнения. ИДЗ удалось!! :)
